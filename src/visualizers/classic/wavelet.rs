...
pub fn draw_wavelet(prog: &mut crate::data::Program, stream: &mut crate::audio::SampleArr) {
...
pub fn draw_wavelet_(prog: &mut crate::data::Program, stream: &mut crate::audio::SampleArr) {
...
fn wavelet_xy_interpolated(
    w: &[Cplx],
    p: Cplx,
    pow: usize, /*, itpl: fn(f64, f64, f64)->f64*/
) -> Cplx {
    let pf = pow as f64;
    let l = w.len();
    let lf = l as f64;
